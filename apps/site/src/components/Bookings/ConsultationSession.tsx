	...
	return (
		<div className=" flex h-full max-w-md flex-col gap-3 rounded-lg bg-secondary p-8 md:max-w-lg lg:max-w-xl  2xl:justify-between ">
			...
			<p className="text-justify text-primary ">
				A FREE 20 minute zoom meeting where you will meet me, discuss
				your goals, wants, and needs for your voice journey, and learn
				more about me, my methodology and teaching style. At the end of
				the consultation we will either book you for your first session,
				or you will leave with a list contact info for several of my

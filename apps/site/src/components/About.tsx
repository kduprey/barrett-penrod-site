	...
	>
		<div className="flex flex-col sm:w-1/4 md:space-y-10">
			...
			<div className="mx-auto w-2/3 md:w-auto" data-cy="about-headshot">
				<Image alt="Barrett Penrod" src={headshot1} />
			</div>
		</div>
		<section className=" md:w-1/2 md:px-6">
			...
			<p className="text-slate-800">
				...
				me to tell you about me and what I do &ndash; we&rsquo;d be talking for
				a few good hours. Expect me to geek out about the human voice a lot.
				I&rsquo;ll tell you what I like to do outside of work to keep balanced.
				I&rsquo;ll talk about where my partner and I have traveled, my favorite
				true crime podcast I&rsquo;ve been listening to, and what the last show
				on Broadway was that gave me goosebumps. I&rsquo;ll also want to know
				what you&rsquo;re excited about or working on! <br />
				<br /> To list some specifics about my work &ndash; I&rsquo;ve got a big
				tenor voice. I also have a strong lower end, so I often venture into
				Baritone territory depending on the project. I&rsquo;m just as
		...
		<div className="space-y-4 md:w-1/4">
			<div className="grid grid-cols-2 gap-2">
				...
				<Image
					...
					src={halloween}
				/>
				<Image alt="Post Workout" src={postWorkout} />
			</div>
		</div>
	</div>
);

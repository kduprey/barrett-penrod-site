...
export const bundles: LessonBundle[] = [
  {
    ...
    price: "420",
    priceID: {
      test: { price: "price_1PHTBpAcYqnDcPUlhTwbopk8", quantity: 1 },
  ...
  },
  {
    ...
    price: "600",
    priceID: {
      test: { price: "price_1PHTCdAcYqnDcPUlzGkOQDTo", quantity: 1 },
  ...
  },
  {
    ...
    price: "780",
    priceID: {
      test: { price: "price_1PHTD0AcYqnDcPUl4apfwoZJ", quantity: 1 },
  ...
  },
  {
    ...
    price: "1000",
    priceID: {
      test: { price: "price_1PHTDIAcYqnDcPUlGgeEQqHr", quantity: 1 },
...
export const Prices: Price[] = [
  {
    name: "SVS Session",
    priceID: {
      test: { price: "price_1PJQ7PAcYqnDcPUl755vmFxc", quantity: 1 },
  ...
  },
  {
    ...
    priceID: {
      test: { price: "price_1PJaXRAcYqnDcPUlAWOjAOx4", quantity: 1 },

...
export const VercelInviteUserEmail = ({
  ...
  const previewText = `Barrett Penrod Voice Studio - Session Booking Confirmation`;
      ...
      >
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-[40px] w-[465px] rounded border border-solid border-[#eaeaea] p-[20px]">
            ...
            <Text className="text-[14px] leading-[24px] text-black">
              You have booked the {sessionType}, at{" "}
              {startDate.toLocaleTimeString()} on{" "}
            ...
            <Section>
              <Text>
                ...
                folder prior to our session. If you have not received access to

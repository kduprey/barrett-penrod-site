...
const About = () => {
	return (
		<div
			id="about-me"
			data-cy="about"
			className="flex flex-col items-center justify-center space-y-4 bg-slate-200 px-8 py-6 md:flex-row md:justify-evenly md:space-y-0"
		>
			...
			<section className=" md:w-1/2 md:px-6">
				<h2 className="text-primary hidden pb-4 text-center md:block md:self-start">
					About Me
				</h2>

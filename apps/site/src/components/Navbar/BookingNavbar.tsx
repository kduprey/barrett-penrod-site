...
const BookingNavbar = () => {
	...
	return (
		<nav className="booking bg-primary sticky left-0 top-0 z-[60] flex max-h-[6em] w-full items-center justify-between p-5 shadow-lg md:justify-between md:pt-6">
			<Link href={"/bookings"} passHref>
				<h1 className=" text-secondary w-full min-w-[8em] max-w-[10em] grow text-lg font-light hover:text-white sm:text-xl sm:font-medium md:max-w-[12em] lg:text-2xl">
			...
			{/* Mobile Nav Modal */}
			<div
				className={`bg-primary fixed top-[6em] z-[70] flex flex-col items-center p-6 transition-all duration-300 ease-in-out md:hidden ${

...
export const accountBacsDebitPaymentsSettingsSchema = z.object({
	display_name: z.string().max(5000).optional(),
});
...
export const accountDashboardSettingsSchema = z.object({
	display_name: z.string().max(5000).optional().nullable(),
	timezone: z.string().max(5000).optional().nullable(),
});
...
export const accountPaymentsSettingsSchema = z.object({
	statement_descriptor: z.string().max(5000).optional().nullable(),
	statement_descriptor_kana: z.string().max(5000).optional().nullable(),
	statement_descriptor_kanji: z.string().max(5000).optional().nullable(),
	statement_descriptor_prefix_kana: z.string().max(5000).optional().nullable(),
	statement_descriptor_prefix_kanji: z.string().max(5000).optional().nullable(),
});
...
export const accountTermsOfServiceSchema = z.object({
	...
	ip: z.string().max(5000).optional().nullable(),
...
export const accountTosAcceptanceSchema = z.object({
	...
	user_agent: z.string().max(5000).optional().nullable(),
});
...
export const addressSchema = z.object({
	city: z.string().max(5000).optional().nullable(),
	country: z.string().max(5000).optional().nullable(),
	line1: z.string().max(5000).optional().nullable(),
	line2: z.string().max(5000).optional().nullable(),
	postal_code: z.string().max(5000).optional().nullable(),
	state: z.string().max(5000).optional().nullable(),
});
...
export const applicationSchema = z.object({
	id: z.string().max(5000),
	name: z.string().max(5000).optional().nullable(),
...
export const billingDetailsSchema = z.object({
	...
	email: z.string().max(5000).optional().nullable(),
	name: z.string().max(5000).optional().nullable(),
	phone: z.string().max(5000).optional().nullable(),
});
...
export const checkoutAcssDebitMandateOptionsSchema = z.object({
	...
	default_for: z
		...
		.optional(),
	interval_description: z.string().max(5000).optional().nullable(),
	payment_schedule: z
		.union([
			z.literal("combined"),
			z.literal("interval"),
...
export const customerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferResourceEuBankTransferSchema = z.object(
	{
		bic: z.string().max(5000).optional().nullable(),
		iban_last4: z.string().max(5000).optional().nullable(),
		sender_name: z.string().max(5000).optional().nullable(),
	}
);
...
export const deletedBankAccountSchema = z.object({
	currency: z.string().max(5000).optional().nullable(),
	deleted: z.literal(true),
	id: z.string().max(5000),
...
export const feeSchema = z.object({
	amount: z.number(),
	application: z.string().max(5000).optional().nullable(),
	currency: z.string(),
...
export const financialConnectionsAccountOwnerSchema = z.object({
	...
	phone: z.string().max(5000).optional().nullable(),
	raw_address: z.string().max(5000).optional().nullable(),
...
export const fundingInstructionsBankTransferZenginRecordSchema = z.object({
	account_holder_name: z.string().max(5000).optional().nullable(),
	account_number: z.string().max(5000).optional().nullable(),
	account_type: z.string().max(5000).optional().nullable(),
	bank_code: z.string().max(5000).optional().nullable(),
	bank_name: z.string().max(5000).optional().nullable(),
	branch_code: z.string().max(5000).optional().nullable(),
	branch_name: z.string().max(5000).optional().nullable(),
});
...
export const gelatoVerifiedOutputsSchema = z.object({
	...
	first_name: z.string().max(5000).optional().nullable(),
	id_number: z.string().max(5000).optional().nullable(),
	id_number_type: z
		.union([z.literal("br_cpf"), z.literal("sg_nric"), z.literal("us_ssn")])
		.optional()
		.nullable(),
	last_name: z.string().max(5000).optional().nullable(),
});
...
export const inboundTransfersPaymentMethodDetailsUsBankAccountSchema = z.object(
	{
		...
		account_type: z
			...
			.nullable(),
		bank_name: z.string().max(5000).optional().nullable(),
		fingerprint: z.string().max(5000).optional().nullable(),
		last4: z.string().max(5000).optional().nullable(),
		network: z.literal("ach"),
		routing_number: z.string().max(5000).optional().nullable(),
	}
);
...
export const invoiceSettingRenderingOptionsSchema = z.object({
	amount_tax_display: z.string().max(5000).optional().nullable(),
});
...
export const invoicesLineItemsCreditedItemsSchema = z.object({
	invoice: z.string().max(5000),
	invoice_line_items: z.array(z.string()),
});

export const invoicesLineItemsProrationDetailsSchema = z.object({
	credited_items: invoicesLineItemsCreditedItemsSchema.optional().nullable(),
});
...
export const issuingAuthorizationMerchantDataSchema = z.object({
	...
	postal_code: z.string().max(5000).optional().nullable(),
	state: z.string().max(5000).optional().nullable(),
	terminal_id: z.string().max(5000).optional().nullable(),
});

export const issuingAuthorizationNetworkDataSchema = z.object({
	acquiring_institution_id: z.string().max(5000).optional().nullable(),
});
...
export const issuingAuthorizationRequestSchema = z.object({
	...
	reason_message: z.string().max(5000).optional().nullable(),
});
...
export const issuingAuthorizationTreasurySchema = z.object({
	...
	transaction: z.string().max(5000).optional().nullable(),
});
...
export const issuingCardShippingCustomsSchema = z.object({
	eori_number: z.string().max(5000).optional().nullable(),
});
...
export const issuingCardWalletsSchema = z.object({
	...
	primary_account_identifier: z.string().max(5000).optional().nullable(),
});
...
export const issuingDisputeTreasurySchema = z.object({
	debit_reversal: z.string().max(5000).optional().nullable(),
...
export const issuingTransactionFlightDataLegSchema = z.object({
	arrival_airport_code: z.string().max(5000).optional().nullable(),
	carrier: z.string().max(5000).optional().nullable(),
	departure_airport_code: z.string().max(5000).optional().nullable(),
	flight_number: z.string().max(5000).optional().nullable(),
	service_class: z.string().max(5000).optional().nullable(),
...
export const issuingTransactionTreasurySchema = z.object({
	received_credit: z.string().max(5000).optional().nullable(),
	received_debit: z.string().max(5000).optional().nullable(),
});
...
export const legalEntityJapanAddressSchema = z.object({
	...
	postal_code: z.string().max(5000).optional().nullable(),
	state: z.string().max(5000).optional().nullable(),
	town: z.string().max(5000).optional().nullable(),
});
...
export const networksSchema = z.object({
	...
	preferred: z.string().max(5000).optional().nullable(),
});
...
export const notificationEventRequestSchema = z.object({
	id: z.string().max(5000).optional().nullable(),
	idempotency_key: z.string().max(5000).optional().nullable(),
});

export const offlineAcceptanceSchema = z.object({});

export const onlineAcceptanceSchema = z.object({
	ip_address: z.string().max(5000).optional().nullable(),
	user_agent: z.string().max(5000).optional().nullable(),
});
...
export const paymentFlowsPrivatePaymentMethodsAlipayDetailsSchema = z.object({
	...
	fingerprint: z.string().max(5000).optional().nullable(),
	transaction_id: z.string().max(5000).optional().nullable(),
});
...
export const paymentIntentNextActionAlipayHandleRedirectSchema = z.object({
	native_data: z.string().max(5000).optional().nullable(),
	native_url: z.string().max(5000).optional().nullable(),
	return_url: z.string().max(5000).optional().nullable(),
	url: z.string().max(5000).optional().nullable(),
});

export const paymentIntentNextActionBoletoSchema = z.object({
	expires_at: z.number().optional().nullable(),
	hosted_voucher_url: z.string().max(5000).optional().nullable(),
	number: z.string().max(5000).optional().nullable(),
	pdf: z.string().max(5000).optional().nullable(),
});
...
export const paymentIntentNextActionPaynowDisplayQrCodeSchema = z.object({
	...
	hosted_instructions_url: z.string().max(5000).optional().nullable(),
	image_url_png: z.string().max(5000),
	image_url_svg: z.string().max(5000),
});
...
export const paymentIntentPaymentMethodOptionsLinkSchema = z.object({
	...
	persistent_token: z.string().max(5000).optional().nullable(),
	setup_future_usage: z
...
export const paymentLinksResourceCustomFieldsLabelSchema = z.object({
	custom: z.string().max(5000).optional().nullable(),
...
export const paymentMethodAcssDebitSchema = z.object({
	bank_name: z.string().max(5000).optional().nullable(),
	fingerprint: z.string().max(5000).optional().nullable(),
	institution_number: z.string().max(5000).optional().nullable(),
	last4: z.string().max(5000).optional().nullable(),
	transit_number: z.string().max(5000).optional().nullable(),
});
...
export const paymentMethodAuBecsDebitSchema = z.object({
	bsb_number: z.string().max(5000).optional().nullable(),
	fingerprint: z.string().max(5000).optional().nullable(),
	last4: z.string().max(5000).optional().nullable(),
});
...
export const paymentMethodBacsDebitSchema = z.object({
	fingerprint: z.string().max(5000).optional().nullable(),
	last4: z.string().max(5000).optional().nullable(),
	sort_code: z.string().max(5000).optional().nullable(),
});
...
export const paymentMethodCardChecksSchema = z.object({
	address_line1_check: z.string().max(5000).optional().nullable(),
	address_postal_code_check: z.string().max(5000).optional().nullable(),
	cvc_check: z.string().max(5000).optional().nullable(),
});
...
export const paymentMethodDetailsAchCreditTransferSchema = z.object({
	...
	bank_name: z.string().max(5000).optional().nullable(),
	routing_number: z.string().max(5000).optional().nullable(),
	swift_code: z.string().max(5000).optional().nullable(),
});
...
export const paymentMethodDetailsAfterpayClearpaySchema = z.object({
	reference: z.string().max(5000).optional().nullable(),
});
...
export const paymentMethodDetailsBacsDebitSchema = z.object({
	fingerprint: z.string().max(5000).optional().nullable(),
	last4: z.string().max(5000).optional().nullable(),
	mandate: z.string().max(5000).optional().nullable(),
	sort_code: z.string().max(5000).optional().nullable(),
});
...
export const paymentMethodDetailsCardPresentReceiptSchema = z.object({
	account_type: z
		...
		.optional(),
	application_cryptogram: z.string().max(5000).optional().nullable(),
	application_preferred_name: z.string().max(5000).optional().nullable(),
	authorization_code: z.string().max(5000).optional().nullable(),
	authorization_response_code: z.string().max(5000).optional().nullable(),
	cardholder_verification_method: z.string().max(5000).optional().nullable(),
	dedicated_file_name: z.string().max(5000).optional().nullable(),
	terminal_verification_results: z.string().max(5000).optional().nullable(),
	transaction_status_information: z.string().max(5000).optional().nullable(),
});
...
export const paymentMethodDetailsEpsSchema = z.object({
	bank: z
		...
		.optional()
		.nullable(),
	verified_name: z.string().max(5000).optional().nullable(),
});
...
export const paymentMethodDetailsKlarnaSchema = z.object({
	payment_method_category: z.string().max(5000).optional().nullable(),
	preferred_locale: z.string().max(5000).optional().nullable(),
});
...
export const paymentMethodDetailsMultibancoSchema = z.object({
	entity: z.string().max(5000).optional().nullable(),
	reference: z.string().max(5000).optional().nullable(),
});
...
export const paymentMethodDetailsPixSchema = z.object({
	bank_transaction_id: z.string().max(5000).optional().nullable(),
});
...
export const paymentMethodLinkSchema = z.object({
	email: z.string().max(5000).optional().nullable(),
	persistent_token: z.string().max(5000).optional(),
});
...
export const paymentMethodOptionsKonbiniSchema = z.object({
	confirmation_number: z.string().max(5000).optional().nullable(),
	expires_after_days: z.number().optional().nullable(),
	expires_at: z.number().optional().nullable(),
...
export const paymentMethodOptionsWechatPaySchema = z.object({
	app_id: z.string().max(5000).optional().nullable(),
	client: z
...
export const portalBusinessProfileSchema = z.object({
	headline: z.string().max(5000).optional().nullable(),
	privacy_policy_url: z.string().max(5000).optional().nullable(),
	terms_of_service_url: z.string().max(5000).optional().nullable(),
});
...
export const promotionCodesResourceRestrictionsSchema = z.object({
	...
	minimum_amount_currency: z.string().max(5000).optional().nullable(),
});
...
export const radarReviewResourceLocationSchema = z.object({
	...
	region: z.string().max(5000).optional().nullable(),
});

export const radarReviewResourceSessionSchema = z.object({
	browser: z.string().max(5000).optional().nullable(),
	device: z.string().max(5000).optional().nullable(),
	platform: z.string().max(5000).optional().nullable(),
	version: z.string().max(5000).optional().nullable(),
});
...
export const shippingSchema = z.object({
	...
	phone: z.string().max(5000).optional().nullable(),
	tracking_number: z.string().max(5000).optional().nullable(),
});
...
export const sourceOrderItemSchema = z.object({
	...
	currency: z.string().max(5000).optional().nullable(),
	description: z.string().max(5000).optional().nullable(),
	parent: z.string().max(5000).optional().nullable(),
	quantity: z.number().optional(),
	type: z.string().max(5000).optional().nullable(),
});
...
export const sourceOwnerSchema = z.object({
	...
	verified_email: z.string().max(5000).optional().nullable(),
	verified_name: z.string().max(5000).optional().nullable(),
	verified_phone: z.string().max(5000).optional().nullable(),
});
...
export const sourceRedirectFlowSchema = z.object({
	failure_reason: z.string().max(5000).optional().nullable(),
	return_url: z.string().max(5000),
	status: z.string().max(5000),
...
export const taxIdVerificationSchema = z.object({
	...
	verified_address: z.string().max(5000).optional().nullable(),
	verified_name: z.string().max(5000).optional().nullable(),
});
...
export const taxProductResourceShippingCostSchema = z.object({
	amount: z.number(),
	amount_tax: z.number(),
...
export const taxProductResourceTaxTransactionResourceReversalSchema = z.object({
	original_transaction: z.string().max(5000).optional().nullable(),
});
...
export const taxRateSchema = z.object({
	...
	id: z.string().max(5000),
	inclusive: z.boolean(),
	jurisdiction: z.string().max(5000).optional().nullable(),
	livemode: z.boolean(),
...
export const treasuryReceivedDebitsResourceDebitReversalLinkedFlowsSchema = z.object(
	{
		issuing_dispute: z.string().max(5000).optional().nullable(),
	}
);

export const treasuryReceivedDebitsResourceLinkedFlowsSchema = z.object({
	debit_reversal: z.string().max(5000).optional().nullable(),
	inbound_transfer: z.string().max(5000).optional().nullable(),
	issuing_authorization: z.string().max(5000).optional().nullable(),
	issuing_transaction: z.string().max(5000).optional().nullable(),
});
...
export const usageRecordSummarySchema = z.object({
	id: z.string().max(5000),
	invoice: z.string().max(5000).optional().nullable(),
	livemode: z.boolean(),
...
export const webhookEndpointSchema = z.object({
	api_version: z.string().max(5000).optional().nullable(),
	application: z.string().max(5000).optional().nullable(),
	created: z.number(),
	description: z.string().max(5000).optional().nullable(),
...
export const accountBusinessProfileSchema = z.object({
	mcc: z.string().max(5000).optional().nullable(),
	name: z.string().max(5000).optional().nullable(),
	product_description: z.string().max(40000).optional().nullable(),
	support_address: addressSchema.optional().nullable(),
	support_email: z.string().max(5000).optional().nullable(),
	support_phone: z.string().max(5000).optional().nullable(),
	support_url: z.string().max(5000).optional().nullable(),
	url: z.string().max(5000).optional().nullable(),
});
...
export const accountCapabilityFutureRequirementsSchema = z.object({
	...
	currently_due: z.array(z.string()),
	disabled_reason: z.string().max(5000).optional().nullable(),
	errors: z.array(accountRequirementsErrorSchema),
	eventually_due: z.array(z.string()),
	past_due: z.array(z.string()),
	pending_verification: z.array(z.string()),
...
export const accountCardPaymentsSettingsSchema = z.object({
	...
	statement_descriptor_prefix: z.string().max(5000).optional().nullable(),
	statement_descriptor_prefix_kana: z.string().max(5000).optional().nullable(),
	statement_descriptor_prefix_kanji: z.string().max(5000).optional().nullable(),
});
...
export const chargeOutcomeSchema = z.object({
	network_status: z.string().max(5000).optional().nullable(),
	reason: z.string().max(5000).optional().nullable(),
	risk_level: z.string().max(5000).optional(),
	risk_score: z.number().optional(),
	rule: z.union([z.string(), ruleSchema]).optional(),
	seller_message: z.string().max(5000).optional().nullable(),
	type: z.string().max(5000),
});
...
export const gelatoDocumentReportSchema = z.object({
	...
	issuing_country: z.string().max(5000).optional().nullable(),
	last_name: z.string().max(5000).optional().nullable(),
	number: z.string().max(5000).optional().nullable(),
...
export const gelatoSelfieReportSchema = z.object({
	document: z.string().max(5000).optional().nullable(),
	error: gelatoSelfieReportErrorSchema.optional().nullable(),
	selfie: z.string().max(5000).optional().nullable(),
	status: z.union([z.literal("unverified"), z.literal("verified")]),
});
...
export const identityVerificationReportSchema = z.object({
	...
	verification_session: z.string().max(5000).optional().nullable(),
});

export const identityVerificationSessionSchema = z.object({
	client_secret: z.string().max(5000).optional().nullable(),
	created: z.number(),
	id: z.string().max(5000),
	...
	type: z
		.union([z.literal("document"), z.literal("id_number")])
		.optional()
		.nullable(),
	url: z.string().max(5000).optional().nullable(),
...
export const issuingCardShippingSchema = z.object({
	...
	name: z.string().max(5000),
	phone_number: z.string().max(5000).optional().nullable(),
	...
	status: z
		...
		.nullable(),
	tracking_number: z.string().max(5000).optional().nullable(),
	tracking_url: z.string().max(5000).optional().nullable(),
...
export const issuingTransactionFlightDataSchema = z.object({
	...
	passenger_name: z.string().max(5000).optional().nullable(),
	refundable: z.boolean().optional().nullable(),
	segments: z
		.array(issuingTransactionFlightDataLegSchema)
		.optional()
		.nullable(),
	travel_agency: z.string().max(5000).optional().nullable(),
});
...
export const paymentMethodCardWalletSchema = z.object({
	...
	dynamic_last4: z.string().max(5000).optional().nullable(),
...
export const paymentMethodDetailsCardPresentSchema = z.object({
	...
	brand: z.string().max(5000).optional().nullable(),
	capture_before: z.number().optional(),
	cardholder_name: z.string().max(5000).optional().nullable(),
	country: z.string().max(5000).optional().nullable(),
	emv_auth_data: z.string().max(5000).optional().nullable(),
	exp_month: z.number(),
	exp_year: z.number(),
	fingerprint: z.string().max(5000).optional().nullable(),
	funding: z.string().max(5000).optional().nullable(),
	generated_card: z.string().max(5000).optional().nullable(),
	incremental_authorization_supported: z.boolean(),
	last4: z.string().max(5000).optional().nullable(),
	network: z.string().max(5000).optional().nullable(),
...
export const paymentMethodUsBankAccountSchema = z.object({
	...
	account_type: z
		...
		.nullable(),
	bank_name: z.string().max(5000).optional().nullable(),
	financial_connections_account: z.string().max(5000).optional().nullable(),
	fingerprint: z.string().max(5000).optional().nullable(),
	last4: z.string().max(5000).optional().nullable(),
...
export const invoicesPaymentSettingsSchema = z.object({
	default_mandate: z.string().max(5000).optional().nullable(),
...
export const taxCalculationLineItemSchema = z.object({
	...
	product: z.string().max(5000).optional().nullable(),
	quantity: z.number(),
	reference: z.string().max(5000).optional().nullable(),
	tax_behavior: z.union([z.literal("exclusive"), z.literal("inclusive")]),
	tax_breakdown: z
...
export const taxTransactionSchema = z.object({
	created: z.number(),
	currency: z.string().max(5000),
	customer: z.string().max(5000).optional().nullable(),
	...
	reversal: taxProductResourceTaxTransactionResourceReversalSchema
		.optional()
		.nullable(),
	shipping_cost: taxProductResourceShippingCostSchema.optional().nullable(),
	tax_date: z.number(),
	type: z.union([z.literal("reversal"), z.literal("transaction")]),
});
...
export const treasuryFinancialAccountsResourceFinancialAddressesFeaturesSchema = z.object(
	{
		aba: treasuryFinancialAccountsResourceToggleSettingsSchema.optional(),
	}
);
...
export const billingPortalConfigurationSchema = z.object({
	...
	created: z.number(),
	default_return_url: z.string().max(5000).optional().nullable(),
...
export const billingPortalSessionSchema = z.object({
	...
	on_behalf_of: z.string().max(5000).optional().nullable(),
	return_url: z.string().max(5000).optional().nullable(),
	url: z.string().max(5000),
});
...
export const accountBrandingSettingsSchema: z.ZodSchema<AccountBrandingSettings> = z.lazy(
	() =>
		z.object({
			...
			primary_color: z.string().max(5000).optional().nullable(),
			secondary_color: z.string().max(5000).optional().nullable(),
		})
);
...
export const bankAccountSchema: z.ZodSchema<BankAccount> = z.lazy(() =>
	z.object({
		...
		account_holder_name: z.string().max(5000).optional().nullable(),
		account_holder_type: z.string().max(5000).optional().nullable(),
		account_type: z.string().max(5000).optional().nullable(),
...
export const cardSchema: z.ZodSchema<Card> = z.lazy(() =>
	z.object({
		account: z.union([z.string(), accountSchema]).optional().nullable(),
		address_city: z.string().max(5000).optional().nullable(),
		address_country: z.string().max(5000).optional().nullable(),
		address_line1: z.string().max(5000).optional().nullable(),
		address_line1_check: z.string().max(5000).optional().nullable(),
		address_line2: z.string().max(5000).optional().nullable(),
		address_state: z.string().max(5000).optional().nullable(),
		address_zip: z.string().max(5000).optional().nullable(),
		address_zip_check: z.string().max(5000).optional().nullable(),
		available_payout_methods: z
			.array(z.union([z.literal("instant"), z.literal("standard")]))
			.optional()
			.nullable(),
		...
		name: z.string().max(5000).optional().nullable(),
		object: z.literal("card"),
		status: z.string().max(5000).optional().nullable(),
		tokenization_method: z.string().max(5000).optional().nullable(),
	})
);
...
export const chargeSchema: z.ZodSchema<Charge> = z.lazy(() =>
	z.object({
		...
		calculated_statement_descriptor: z.string().max(5000).optional().nullable(),
		captured: z.boolean(),
		created: z.number(),
		currency: z.string(),
		customer: z
		...
		failure_balance_transaction: z
			...
			.optional()
			.nullable(),
		failure_code: z.string().max(5000).optional().nullable(),
		failure_message: z.string().max(5000).optional().nullable(),
		...
		payment_intent: z
			...
			.optional()
			.nullable(),
		payment_method: z.string().max(5000).optional().nullable(),
		payment_method_details: paymentMethodDetailsSchema.optional().nullable(),
		radar_options: radarRadarOptionsSchema.optional(),
		receipt_email: z.string().max(5000).optional().nullable(),
		receipt_number: z.string().max(5000).optional().nullable(),
		receipt_url: z.string().max(5000).optional().nullable(),
		refunded: z.boolean(),
		refunds: z
			.object({
		...
		source_transfer: z
			...
			.nullable(),
		statement_descriptor: z.string().max(5000).optional().nullable(),
		statement_descriptor_suffix: z.string().max(5000).optional().nullable(),
		status: z.union([
			z.literal("failed"),
			z.literal("pending"),
			z.literal("succeeded"),
		...
		transfer_group: z.string().max(5000).optional().nullable(),
	})
);
...
export const checkoutSessionSchema: z.ZodSchema<CheckoutSession> = z.lazy(() =>
	z.object({
		...
		billing_address_collection: z
			...
			.optional()
			.nullable(),
		cancel_url: z.string().max(5000).optional().nullable(),
		client_reference_id: z.string().max(5000).optional().nullable(),
		...
		customer_details: paymentPagesCheckoutSessionCustomerDetailsSchema
			.optional()
			.nullable(),
		customer_email: z.string().max(5000).optional().nullable(),
		expires_at: z.number(),
		id: z.string().max(5000),
		invoice: z.union([z.string(), invoiceSchema]).optional().nullable(),
		...
		recovered_from: z.string().max(5000).optional().nullable(),
		setup_intent: z
...
export const customerSchema: z.ZodSchema<Customer> = z.lazy(() =>
	z.object({
		...
		invoice_prefix: z.string().max(5000).optional().nullable(),
...
export const deletedDiscountSchema: z.ZodSchema<DeletedDiscount> = z.lazy(() =>
	z.object({
		checkout_session: z.string().max(5000).optional().nullable(),
		coupon: couponSchema,
		customer: z
			.union([z.string(), customerSchema, deletedCustomerSchema])
			.optional()
		...
		id: z.string().max(5000),
		invoice: z.string().max(5000).optional().nullable(),
		invoice_item: z.string().max(5000).optional().nullable(),
		...
		promotion_code: z
			...
			.nullable(),
		start: z.number(),
		subscription: z.string().max(5000).optional().nullable(),
	})
);
...
export const disputeEvidenceSchema: z.ZodSchema<DisputeEvidence> = z.lazy(() =>
	z.object({
		access_activity_log: z.string().max(150000).optional().nullable(),
		billing_address: z.string().max(5000).optional().nullable(),
		...
		cancellation_policy_disclosure: z
			...
			.optional()
			.nullable(),
		cancellation_rebuttal: z.string().max(150000).optional().nullable(),
		customer_communication: z
			.union([z.string(), fileSchema])
			.optional()
			.nullable(),
		customer_email_address: z.string().max(5000).optional().nullable(),
		customer_name: z.string().max(5000).optional().nullable(),
		customer_purchase_ip: z.string().max(5000).optional().nullable(),
		customer_signature: z.union([z.string(), fileSchema]).optional().nullable(),
		duplicate_charge_documentation: z
			.union([z.string(), fileSchema])
			.optional()
			.nullable(),
		duplicate_charge_explanation: z.string().max(150000).optional().nullable(),
		duplicate_charge_id: z.string().max(5000).optional().nullable(),
		product_description: z.string().max(150000).optional().nullable(),
		receipt: z.union([z.string(), fileSchema]).optional().nullable(),
		refund_policy: z.union([z.string(), fileSchema]).optional().nullable(),
		refund_policy_disclosure: z.string().max(150000).optional().nullable(),
		refund_refusal_explanation: z.string().max(150000).optional().nullable(),
		service_date: z.string().max(5000).optional().nullable(),
		service_documentation: z
			.union([z.string(), fileSchema])
			.optional()
			.nullable(),
		shipping_address: z.string().max(5000).optional().nullable(),
		shipping_carrier: z.string().max(5000).optional().nullable(),
		shipping_date: z.string().max(5000).optional().nullable(),
		shipping_documentation: z
			.union([z.string(), fileSchema])
			.optional()
			.nullable(),
		shipping_tracking_number: z.string().max(5000).optional().nullable(),
		uncategorized_file: z.union([z.string(), fileSchema]).optional().nullable(),
		uncategorized_text: z.string().max(150000).optional().nullable(),
	})
);
...
export const fileSchema: z.ZodSchema<File> = z.lazy(() =>
	z.object({
		created: z.number(),
		expires_at: z.number().optional().nullable(),
		filename: z.string().max(5000).optional().nullable(),
		id: z.string().max(5000),
		links: z
			.object({
...
export const invoiceSchema: z.ZodSchema<Invoice> = z.lazy(() =>
	z.object({
		account_country: z.string().max(5000).optional().nullable(),
		account_name: z.string().max(5000).optional().nullable(),
		account_tax_ids: z
		...
		customer_email: z.string().max(5000).optional().nullable(),
		customer_name: z.string().max(5000).optional().nullable(),
		customer_phone: z.string().max(5000).optional().nullable(),
		...
		footer: z.string().max(5000).optional().nullable(),
		from_invoice: invoicesFromInvoiceSchema.optional().nullable(),
		hosted_invoice_url: z.string().max(5000).optional().nullable(),
		id: z.string().max(5000).optional(),
		invoice_pdf: z.string().max(5000).optional().nullable(),
...
export const issuingAuthorizationSchema: z.ZodSchema<IssuingAuthorization> = z.lazy(
	() =>
		z.object({
			...
			wallet: z.string().max(5000).optional().nullable(),
		})
);
...
export const issuingCardSchema: z.ZodSchema<IssuingCard> = z.lazy(() =>
	z.object({
		...
		exp_month: z.number(),
		exp_year: z.number(),
		financial_account: z.string().max(5000).optional().nullable(),
		id: z.string().max(5000),
		last4: z.string().max(5000),
		livemode: z.boolean(),
		metadata: z.record(z.string()),
...
export const issuingDisputeCanceledEvidenceSchema: z.ZodSchema<IssuingDisputeCanceledEvidence> = z.lazy(
	() =>
		z.object({
			...
			cancellation_reason: z.string().max(5000).optional().nullable(),
...
export const issuingDisputeMerchandiseNotAsDescribedEvidenceSchema: z.ZodSchema<IssuingDisputeMerchandiseNotAsDescribedEvidence> = z.lazy(
	() =>
		z.object({
			...
			return_description: z.string().max(5000).optional().nullable(),
			return_status: z
				.union([z.literal("merchant_rejected"), z.literal("successful")])
				.optional()
				.nullable(),
...
export const legalEntityCompanySchema: z.ZodSchema<LegalEntityCompany> = z.lazy(
	() =>
		z.object({
			...
			name: z.string().max(5000).optional().nullable(),
			name_kana: z.string().max(5000).optional().nullable(),
			name_kanji: z.string().max(5000).optional().nullable(),
...
export const legalEntityCompanyVerificationDocumentSchema: z.ZodSchema<LegalEntityCompanyVerificationDocument> = z.lazy(
	() =>
		z.object({
			...
			details_code: z.string().max(5000).optional().nullable(),
			front: z.union([z.string(), fileSchema]).optional().nullable(),
		})
);
...
export const lineItemSchema: z.ZodSchema<LineItem> = z.lazy(() =>
	z.object({
		...
		price: priceSchema.optional().nullable(),
		proration: z.boolean(),
		proration_details: invoicesLineItemsProrationDetailsSchema
			.optional()
			.nullable(),
		quantity: z.number().optional().nullable(),
		subscription: z
...
export const paymentMethodCardGeneratedCardSchema: z.ZodSchema<PaymentMethodCardGeneratedCard> = z.lazy(
	() =>
		z.object({
			charge: z.string().max(5000).optional().nullable(),
...
export const personSchema: z.ZodSchema<Person> = z.lazy(() =>
	z.object({
		...
		email: z.string().max(5000).optional().nullable(),
		first_name: z.string().max(5000).optional().nullable(),
		first_name_kana: z.string().max(5000).optional().nullable(),
		first_name_kanji: z.string().max(5000).optional().nullable(),
		...
		last_name: z.string().max(5000).optional().nullable(),
		last_name_kana: z.string().max(5000).optional().nullable(),
		last_name_kanji: z.string().max(5000).optional().nullable(),
		maiden_name: z.string().max(5000).optional().nullable(),
		metadata: z.record(z.string()).optional(),
		nationality: z.string().max(5000).optional().nullable(),
		object: z.literal("person"),
		phone: z.string().max(5000).optional().nullable(),
...
export const planSchema: z.ZodSchema<Plan> = z.lazy(() =>
	z.object({
		...
		livemode: z.boolean(),
		metadata: z.record(z.string()).optional().nullable(),
		nickname: z.string().max(5000).optional().nullable(),
		object: z.literal("plan"),
		product: z
...
export const priceSchema: z.ZodSchema<Price> = z.lazy(() =>
	z.object({
		...
		id: z.string().max(5000),
		livemode: z.boolean(),
		lookup_key: z.string().max(5000).optional().nullable(),
		metadata: z.record(z.string()),
		nickname: z.string().max(5000).optional().nullable(),
		object: z.literal("price"),
...
export const productSchema: z.ZodSchema<Product> = z.lazy(() =>
	z.object({
		...
		statement_descriptor: z.string().max(5000).optional().nullable(),
		tax_code: z.union([z.string(), taxCodeSchema]).optional().nullable(),
		unit_label: z.string().max(5000).optional().nullable(),
		updated: z.number(),
...
export const quoteSchema: z.ZodSchema<Quote> = z.lazy(() =>
	z.object({
		...
		header: z.string().max(5000).optional().nullable(),
		id: z.string().max(5000),
		invoice: z
...
export const reviewSchema: z.ZodSchema<Review> = z.lazy(() =>
	z.object({
		billing_zip: z.string().max(5000).optional().nullable(),
		charge: z.union([z.string(), chargeSchema]).optional().nullable(),
		closed_reason: z
			.union([
				z.literal("approved"),
...
export const subscriptionScheduleSchema: z.ZodSchema<SubscriptionSchedule> = z.lazy(
	() =>
		z.object({
			...
			released_subscription: z.string().max(5000).optional().nullable(),
			status: z.union([
				z.literal("active"),
				z.literal("canceled"),
				z.literal("completed"),
...
export const terminalReaderSchema: z.ZodSchema<TerminalReader> = z.lazy(() =>
	z.object({
		action: terminalReaderReaderResourceReaderActionSchema
			.optional()
			.nullable(),
		device_sw_version: z.string().max(5000).optional().nullable(),
		device_type: z.union([
...
export const tokenSchema: z.ZodSchema<Token> = z.lazy(() =>
	z.object({
		...
		client_ip: z.string().max(5000).optional().nullable(),
		created: z.number(),
		id: z.string().max(5000),
		livemode: z.boolean(),
...
export const treasuryCreditReversalSchema: z.ZodSchema<TreasuryCreditReversal> = z.lazy(
	() =>
		z.object({
			...
			hosted_regulatory_receipt_url: z.string().max(5000).optional().nullable(),
			id: z.string().max(5000),
			livemode: z.boolean(),
			metadata: z.record(z.string()),
...
export const treasuryOutboundPaymentSchema: z.ZodSchema<TreasuryOutboundPayment> = z.lazy(
	() =>
		z.object({
			...
			customer: z.string().max(5000).optional().nullable(),
			description: z.string().max(5000).optional().nullable(),
			destination_payment_method: z.string().max(5000).optional().nullable(),
	...
	() =>
		z.object({
			...
			entries: z
				...
				.nullable(),
			financial_account: z.string().max(5000),
			flow: z.string().max(5000).optional().nullable(),
...
export const treasuryReceivedCreditsResourceLinkedFlowsSchema: z.ZodSchema<TreasuryReceivedCreditsResourceLinkedFlows> = z.lazy(
	() =>
		z.object({
			credit_reversal: z.string().max(5000).optional().nullable(),
			issuing_authorization: z.string().max(5000).optional().nullable(),
			issuing_transaction: z.string().max(5000).optional().nullable(),
			source_flow: z.string().max(5000).optional().nullable(),
			source_flow_details: treasuryReceivedCreditsResourceSourceFlowsDetailsSchema
				.optional()
				.nullable(),
			source_flow_type: z.string().max(5000).optional().nullable(),
		})
);

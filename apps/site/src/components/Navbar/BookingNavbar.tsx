...
const BookingNavbar = () => {
  ...
  return (
    <nav className="booking sticky left-0 top-0 z-[60] flex max-h-[6em] w-full items-center justify-between bg-primary p-5 shadow-lg md:justify-between md:pt-6">
      <Link href={"/voice-studio"} passHref>
